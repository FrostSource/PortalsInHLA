...
---ADDING A CATEGORY
--
-- DebugMenu:AddCategory(Category ID, Display Text)
-- E.g.
-- DebugMenu:AddCategory("my_category", "My Custom Category")
--
---ADDING A TOGGLE STATE BUTTON
--
-- DebugMenu:AddToggle(Category ID, Toggle ID, Text, Console Command or Function, Start On)
-- E.g.
-- DebugMenu:AddToggle("my_category", "portal2_my_toggle", "Toggle God", "god")
--
-- The menu will add 1 or 0 to the command depending on its state.
--
---ADDING A BUTTON
--
-- DebugMenu:AddButton(Category ID, Button ID, Text, Console Command or Function)
-- E.g.
-- DebugMenu:AddButton("my_category", "portal2_my_button", "Main Menu", "map startup")
--
---ADDING A SEPARATOR LINE
--
-- DebugMenu:AddSeparator(Category ID)
-- E.g.
-- DebugMenu:AddSeparator("my_category")
--


DebugMenu:AddCategory("portal2", "Portal 2")
DebugMenu:SetCategoryIndex("portal2", 1) -- appear first in the menu

-- Settings menu testing

DebugMenu:AddToggle("portal2", "portal2_vr_body", "Full VR Body", "portal2_vr_body", EasyConvars:GetBool("portal2_vr_body"))
DebugMenu:AddToggle("portal2", "portal2_custom_hints", "Portal Hints", "portal2_custom_hints", EasyConvars:GetBool("portal2_custom_hints"))

-- This can be moved inside the below 'if' in case we want it only in -dev mode
DebugMenu:AddToggle("portal2", "portal2_noclip_vr", "NoClip VR (Useful if stuck)", "noclip_vr")

-- Debug commands only appear with -dev
if Convars:GetInt("developer") > 0 then

    DebugMenu:AddSeparator("portal2")
    ...
    DebugMenu:AddButton("portal2", "portal2_demo_recording", "Start Recording Demo", function()
        if isRecordingDemo then
            SendToConsole("stop")
            currentDemo = ""
            isRecordingDemo = false
            DebugMenu:SetItemText("portal2", "portal2_demo_recording", "Start Recording Demo")
        else
            local localtime = LocalTime()
            -- remove all whitespace and slashes
            local sanitizedMap = GetMapName():gsub("%s+", ""):gsub("/", "_")
            ...
            SendToConsole("record " .. currentDemo)
            isRecordingDemo = true
            DebugMenu:SetItemText("portal2", "portal2_demo_recording", "Stop Recording Demo")
        end
    end)

    -- These are specific to PortalsInHLA project

    DebugMenu:AddToggle("portal2", "portal_debug_portal_rendering", "Debug Portal Rendering", "portal_debug_portal_rendering")

    DebugMenu:AddToggle("portal2", "portal_debug_portals", "Debug Portals", "portal_debug_portals")

    DebugMenu:AddToggle("portal2", "portal_debug_portalgun", "Debug Portal Gun", "portal_debug_portalgun")

    DebugMenu:AddButton("portal2", "portal_debug_clear", "Debug Clear", "portal_debug_clear")

    -- These are specific to this Portal 2 project

    DebugMenu:AddButton("portal2", "portal2_disable_vis", "Disable Vis", "portal2_disable_vis")

    DebugMenu:AddButton("portal2", "portal2_disable_visboxes", "Disable Vis Boxes", "portal2_disable_visboxes")
    ...
    local function gotoMap(mapName)
        if IsInToolsMode() then
            return "addon_tools_map " .. mapName
        else
            return "addon_play " .. mapName
        end
    end

    DebugMenu:AddButton("portal2", "portal2_sp_a1_intro1", "sp_a1_intro1", gotoMap("sp_a1_intro1"))
    DebugMenu:AddButton("portal2", "portal2_sp_a1_intro2", "sp_a1_intro2", gotoMap("sp_a1_intro2"))
    DebugMenu:AddButton("portal2", "portal2_sp_a1_intro3", "sp_a1_intro3", gotoMap("sp_a1_intro3"))
    DebugMenu:AddButton("portal2", "portal2_sp_a1_intro4", "sp_a1_intro4", gotoMap("sp_a1_intro4"))
    DebugMenu:AddButton("portal2", "portal2_sp_a1_intro5", "sp_a1_intro5", gotoMap("sp_a1_intro5"))
    DebugMenu:AddButton("portal2", "portal2_sp_a1_intro6", "sp_a1_intro6", gotoMap("sp_a1_intro6"))
    DebugMenu:AddButton("portal2", "portal2_sp_a1_intro7", "sp_a1_intro7", gotoMap("sp_a1_intro7"))
    DebugMenu:AddButton("portal2", "portal2_sp_a1_wakeup", "sp_a1_wakeup", gotoMap("sp_a1_wakeup"))
    DebugMenu:AddButton("portal2", "portal2_sp_a2_intro", "sp_a2_intro", gotoMap("sp_a2_intro"))
    DebugMenu:AddButton("portal2", "portal2_turrets_credits", "turrets_credits", gotoMap("turrets_credits"))
